    ...
    [utils.asGridCoord(6, 3)]: [
      {
        ...
        events: [
          ...
          { type: "textMessage", text: "Good morning, Mum. What's going on?", faceHero: "mum" },
          {
            type: "textMessage",
            text: "Son!!! Your dad is missing. He never came back from his trip to the city.",
          },
          { type: "textMessage", text: "What? When did this happen?" },
          {
            type: "textMessage",
            text: "Three days ago. I've tried everything to find him, but I'm afraid I've hit a dead end.",
          },
          { type: "textMessage", text: "Don't worry, Mum. I'll find him. I won't rest until I do." },
